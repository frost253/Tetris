...
public abstract class Block {
                ...
                for (Cell i : cells) {
                    ...
                    if (isLastCell) {
                        ...
                        for (Cell cell : cells) {
                            ...
                            cellArray[cell.y][cell.x].setColor(GamePanel.blank);
                        }
                ...
                for (Cell cell : cells) {
                    ...
                    if (isLastCell) {
                        ...
                        for (Cell j : cells) {
                            ...
                            cellArray[j.y][j.x].setColor(GamePanel.blank);
                        }
    ...
    public void moveDown(Cell[][] cellArray) {
        ...
        for (int i=size; i>=0; i--) {
            ...
            // erases old cells
            cellArray[cells.get(i).y][cells.get(i).x].setColor(GamePanel.blank);
